...
def test_1_1_move_dict_value():
    ...
    my_dict = move_dict_value(my_dict=my_dict, src_key="TB", dest_key="BB", value="sample5")
    assert {"TB": ["sample1", "sample6"], "BB": ["sample5", "sample28", "zip"], "CC": "sample15"} == my_dict
...
def test_1_3_move_dict_value():
    ...
    assert {1: ["sample1", "sample8"], "CC": "sample15"} == my_dict
...
def test_1_4_move_dict_value():
    ...
    my_dict = move_dict_value(my_dict=my_dict, src_key="TB", dest_key="BB", value="sample5")
    assert {"TB": ["sample1", "sample6"], "BB": [True, "zip", "sample28", "sample5"], "CC": "sample15"} == my_dict
...
def test_1_5_move_dict_value():
    ...
    assert {"TB": ["sample5", "sample6"], "BB": [85, "sample28", 50], "CC": "sample15"} == my_dict
