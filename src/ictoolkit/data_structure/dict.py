...
def sort_dict(my_dict: dict[Any, Any], sort: Literal["key", "value"], sort_values: bool = False) -> dict[Any, Any]:
    ...
    type_check(value=my_dict, required_type=dict, tb_remove_name="sort_dict")
    type_check(value=sort, required_type=str, tb_remove_name="sort_dict")
    type_check(value=sort_values, required_type=bool, tb_remove_name="sort_dict")
...
def string_grouper(
    ...
    type_check(value=list_of_strings, required_type=list, tb_remove_name="string_grouper")
    if grouping_value:
        type_check(value=grouping_value, required_type=(str, int), tb_remove_name="string_grouper")
    type_check(value=grouping_option, required_type=int, tb_remove_name="string_grouper")
    type_check(value=case_insensitive, required_type=bool, tb_remove_name="string_grouper")
...
def move_dict_value(
    ...
    Raises:
        ...
        \t\\- The object value '{my_dict}' is not an instance of the required class(es) or subclass(es).
        FTypeError (fexception):
        \t\\- The object value '{src_key}' is not an instance of the required class(es) or subclass(es).
        FTypeError (fexception):
        \t\\- The object value '{dest_key}' is not an instance of the required class(es) or subclass(es).
        FTypeError (fexception):
    ...
    type_check(value=my_dict, required_type=dict, tb_remove_name="move_dict_value")
    type_check(value=src_key, required_type=(str, int, float, bool), tb_remove_name="move_dict_value")
    type_check(value=dest_key, required_type=(str, int, float, bool), tb_remove_name="move_dict_value")
    type_check(value=sort, required_type=bool, tb_remove_name="move_dict_value")
